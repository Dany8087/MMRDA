          ...
          @endif
            ...
            <div class="row">
              ...
              <div class="col col-md-6 col-12">
                ...
                <option name="" value="">Select Company Type</option>
              ...
              <div class="col col-md-6 col-12">
                <div class="mb-4 form-group">
                  ...
                  <input type="text" class="form-control" name="ContactPerson" value="{{old('ContactPerson')}}" placeholder="Enter Contact Persons name" />
              ...
              <div class="col col-md-6 col-12">
                <div class="mb-4 form-group">
                  ...
                  <input type="text" class="form-control" name="ContactNumber" value="{{old('ContactNumber')}}" placeholder="Enter Contact Number" />
              ...
              <div class="col col-md-6 col-12">
                <div class="mb-4 form-group">
                  ...
                  <input type="email" class="form-control" name="Email" value="{{old('Email')}}" placeholder="Enter Regirtered Email" />
